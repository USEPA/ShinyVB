...
loading_project <- reactiveVal(FALSE)
...
corr_choice <- reactiveValues(corr_view = "plot")
select_toggle <- reactiveValues(corr_toggle = "select", feats_toggle = "unselect")
programmatic_feats_update <- reactiveVal(FALSE)
cor_mat  <- reactiveVal(NULL)
corr_tab  <- reactiveVal(NULL)
...
model_feature_ranges = reactiveVal()

pred_table_data = reactiveVal()
LG_pred_table_data = reactiveVal()
XGBCL_pred_table_data = reactiveVal()
XGB_pred_table_data = reactiveVal()
EN_pred_table_data = reactiveVal()