  ...
  sidebarPanel = sidebarPanel(
    ...
    bs_accordion(id = "Discreet_Techniques") %>%
      ...
      bs_append (
        ...
        content = card(
          ...
          fluidRow(column(12,checkboxInput("XGBCL_binarize", "Create Binary Response", TRUE))),
          fluidRow(column(5, numericInput("XGBCL_binarize_crit_value", label = "Threshold", value = 2,step=0.25))),
          fluidRow(column(12,actionButton("run_pred_XGBCL", "XGBCL Predictions", style = 'width:160px; padding:2px;'))),
          fluidRow(column(12,actionButton("run_fitted_XGBCL", "XGBCL Final Fit", style = 'width:160px; padding:2px;'))))) %>%
    ...
    bs_accordion(id = "Continuous_Techniques") %>%
      ...
      bs_append (
        ...
        content = card(
          fluidRow(
            column(12,actionButton("EN_pred", "Model Predictions", style = 'width:180px; padding:4px;'))),
          fluidRow(
            column(12,actionButton("EN_fit", "Final Fitting", style = 'width:150px; padding:4px;'))))) %>%
      ...
      bs_append (
        title = "XGBoost", content= card(
          ...
          fluidRow(column(12,actionButton("run_XGB_predict", "Predictions", style = 'width:130px; padding:2px;'))),
          fluidRow(column(12,align="left",actionButton("XGB_final_fitting", "Fitting", style = 'width:130px; padding:2px;')))),
    ...
    tabsetPanel(id = "modeling_tabs",
                ...
                tabPanel("LG: Fitting",
                         navset_pill_list(widths = c(2,10), well=F,
                                          ...
                                          nav_panel("Scatterplot", fluidRow(column(2,numericInput("LG_fit_dc", label = "Decision Criterion", value = 0.5, min = 0, max=1, step=0.01))),
                                                    plotOutput("LG_scatplot", height="700px",width="100%"),
                                                    fluidRow(column(7,DT::dataTableOutput('LG_confuse'))),
                                                    uiOutput("LG_confuse_text")))),
                tabPanel("XGBCL: Predict",
                         navset_pill_list(widths = c(2,10), well=F,
                                          nav_panel("Results Table",DT::dataTableOutput('XGBCL_preds'),
                                          ...
                                          nav_panel("Scatterplot", fluidRow(column(2,numericInput("XGBCL_pred_dc", label = "Decision Criterion", value = 0.5, min = 0, max=1, step=0.01))),
                                                    plotOutput("XGBCL_pred_scatplot", height="700px",width="100%"),
                ...
                tabPanel("XGBCL: Fitting",
                         navset_pill_list(widths = c(2,10), well=F,
                                          ...
                                          nav_panel("Scatterplot", fluidRow(column(2,numericInput("XGBCL_fit_dc", label = "Decision Criterion", value = 0.5, min = 0, max=1, step=0.01))),
                ...
                tabPanel("XGB: Predict",
                         navset_pill_list(widths = c(2,10), well=F,
                                          ...
                                          nav_panel("SHAP Values", fluidRow(column(4,DT::dataTableOutput('XGB_pred_shapes')))),
